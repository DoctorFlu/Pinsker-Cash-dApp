...
// sets up web3.js
const web3 = new Web3(Web3.givenProvider || "Injected Web3");

const exchange_name = 'Pinsker Cash Exchange'; // TODO: fill in the name of your exchange

const token_name = 'Pinsker Cash';             // TODO: replace with name of your token
const token_symbol = 'PCH';               // TODO: replace with symbol for your token


// TODO: Paste your token contract address and ABI here:
const token_address = '0x614e948d324d91fc889ae95f7a964aa94314a837';                   
const token_abi = [
	{
		"inputs": [
			{
